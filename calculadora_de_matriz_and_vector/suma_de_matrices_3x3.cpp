...
#include "ui_suma_de_matrices_3x3.h"

suma_de_matrices_3x3::suma_de_matrices_3x3(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::suma_de_matrices_3x3)
{
    ui->setupUi(this);
}

suma_de_matrices_3x3::~suma_de_matrices_3x3()
{
    delete ui;
}

void suma_de_matrices_3x3::on_producto_clicked()
{
...
void suma_de_matrices_3x3::on_pushButton_clicked()
{

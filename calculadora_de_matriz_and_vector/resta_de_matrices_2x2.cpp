...
#include "ui_resta_de_matrices_2x2.h"

resta_de_matrices_2x2::resta_de_matrices_2x2(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::resta_de_matrices_2x2)
{
    ui->setupUi(this);
}

resta_de_matrices_2x2::~resta_de_matrices_2x2()
{
    delete ui;
}

void resta_de_matrices_2x2::on_producto_clicked()
{
...
void resta_de_matrices_2x2::on_pushButton_clicked()
{
